                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-10 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                    {{ number_format($applicant->salary) }}
                                </td>
                                ...
                                <td class="px-8 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <button type="button" wire:click="pass({{ $applicant->id }})"
                                        class="bg-gray-600 hover:bg-gray-800 text-white font-bold py-1 px-3 m-1 rounded">
                                        Pass
                                    </button>
                                    <button type="button" wire:click="notPass({{ $applicant->id }})"
                                        class="bg-gray-600 hover:bg-gray-800 text-white font-bold py-1 px-3 m-1 rounded">
                                        Not Pass
                                    </button>
                                    <button type="button" wire:click="cancel({{ $applicant->id }})"
